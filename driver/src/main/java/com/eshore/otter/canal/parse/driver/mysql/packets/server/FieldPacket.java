...
import com.eshore.otter.canal.parse.driver.mysql.utils.LengthCodedStringReader;
...
public class FieldPacket extends PacketWithHeaderPacket {
    ...
    public void fromBytes(byte[] data) throws IOException {
        ...
        int index = 0;
        com.eshore.otter.canal.parse.driver.mysql.utils.LengthCodedStringReader reader = new LengthCodedStringReader(null, index);
        // 1.
        ...
        index++;
        //
        this.character = com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.readUnsignedShortLittleEndian(data, index);
        index += 2;
        //
        this.length = com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.readUnsignedIntLittleEndian(data, index);
        index += 4;
        //

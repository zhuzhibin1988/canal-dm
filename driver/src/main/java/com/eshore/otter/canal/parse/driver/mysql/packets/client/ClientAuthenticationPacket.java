package com.eshore.otter.canal.parse.driver.mysql.packets.client;
...
public class ClientAuthenticationPacket extends PacketWithHeaderPacket {
    ...
    public byte[] toBytes() throws IOException {
        ...
        com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.writeUnsignedIntLittleEndian(clientCapability, out); // remove
        // client_interactive
        // feature

        // 2. write max_packet_size
        com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.writeUnsignedIntLittleEndian(MSC.MAX_PACKET_LENGTH, out);
        ...
        com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.writeNullTerminatedString(getUsername(), out);
        ...
        if (StringUtils.isEmpty(getPassword())) {
            ...
            try {
                ...
                com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.writeBinaryCodedLengthBytes(encryptedPassword, out);
        ...
        if (getDatabaseName() != null) {
            com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.writeNullTerminatedString(getDatabaseName(), out);
        }

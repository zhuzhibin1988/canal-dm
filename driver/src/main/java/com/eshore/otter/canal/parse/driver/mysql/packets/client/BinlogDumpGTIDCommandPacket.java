...
public class BinlogDumpGTIDCommandPacket extends CommandPacket {
    ...
    public byte[] toBytes() throws IOException {
        ...
        // 1. [2] flags
        com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.writeUnsignedShortLittleEndian(BINLOG_THROUGH_GTID, out);
        // 2. [4] server-id
        com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.writeUnsignedIntLittleEndian(slaveServerId, out);
        // 3. [4] binlog-filename-len
        com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.writeUnsignedIntLittleEndian(0, out);
        // 4. [] binlog-filename
        // skip
        // 5. [8] binlog-pos
        com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.writeUnsignedInt64LittleEndian(4, out);

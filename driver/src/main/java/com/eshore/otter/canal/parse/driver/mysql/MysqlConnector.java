package com.eshore.otter.canal.parse.driver.mysql;
...
import com.eshore.otter.canal.parse.driver.mysql.packets.server.AuthSwitchRequestPacket;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.eshore.otter.canal.parse.driver.mysql.packets.HeaderPacket;
import com.eshore.otter.canal.parse.driver.mysql.packets.client.AuthSwitchResponsePacket;
import com.eshore.otter.canal.parse.driver.mysql.packets.client.ClientAuthenticationPacket;
import com.eshore.otter.canal.parse.driver.mysql.packets.client.QuitCommandPacket;
import com.eshore.otter.canal.parse.driver.mysql.socket.SocketChannel;
import com.eshore.otter.canal.parse.driver.mysql.socket.SocketChannelPool;
import com.eshore.otter.canal.parse.driver.mysql.utils.MSC;
import com.eshore.otter.canal.parse.driver.mysql.utils.MySQLPasswordEncrypter;
...
public class MysqlConnector {
    ...
    private void negotiate(SocketChannel channel) throws IOException {
        ...
        if (body[0] < 0) {// check field_count
            if (body[0] == -1) {
                com.eshore.otter.canal.parse.driver.mysql.packets.server.ErrorPacket error = new com.eshore.otter.canal.parse.driver.mysql.packets.server.ErrorPacket();
        ...
        com.eshore.otter.canal.parse.driver.mysql.packets.server.HandshakeInitializationPacket handshakePacket = new com.eshore.otter.canal.parse.driver.mysql.packets.server.HandshakeInitializationPacket();
        ...
        if (marker == -2 || marker == 1) {
            ...
            if (marker == 1) {
                com.eshore.otter.canal.parse.driver.mysql.packets.server.AuthSwitchRequestMoreData packet = new com.eshore.otter.canal.parse.driver.mysql.packets.server.AuthSwitchRequestMoreData();
                packet.fromBytes(body);
                authData = packet.authData;
            } else {
                com.eshore.otter.canal.parse.driver.mysql.packets.server.AuthSwitchRequestPacket packet = new AuthSwitchRequestPacket();
                packet.fromBytes(body);
                authData = packet.authData;
        ...
        if (body[0] < 0) {
            if (body[0] == -1) {
                com.eshore.otter.canal.parse.driver.mysql.packets.server.ErrorPacket err = new com.eshore.otter.canal.parse.driver.mysql.packets.server.ErrorPacket();
                err.fromBytes(body);
    ...
    private void auth323(SocketChannel channel, byte packetSequenceNumber, byte[] seed) throws IOException {
        // auth 323
        com.eshore.otter.canal.parse.driver.mysql.packets.server.Reply323Packet r323 = new com.eshore.otter.canal.parse.driver.mysql.packets.server.Reply323Packet();
    ...
    private byte[] joinAndCreateScrumbleBuff(com.eshore.otter.canal.parse.driver.mysql.packets.server.HandshakeInitializationPacket handshakePacket) throws IOException {

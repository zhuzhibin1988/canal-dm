...
public class OKPacket extends PacketWithHeaderPacket {
    ...
    public void fromBytes(byte[] data) throws IOException {
        ...
        this.affectedRows = com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.readBinaryCodedLengthBytes(data, index);
        index += this.affectedRows.length;
        // 3. read insert id
        this.insertId = com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.readBinaryCodedLengthBytes(data, index);
        ...
        this.warningCount = com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.readUnsignedShortLittleEndian(data, index);
        index += 2;
        // 6. read message.

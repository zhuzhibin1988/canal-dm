...
public class ErrorPacket extends PacketWithHeaderPacket {
    ...
    public void fromBytes(byte[] data) {
        ...
        index++;
        // 2. read error no.
        this.errorNumber = com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.readUnsignedShortLittleEndian(data, index);
        index += 2;
        // 3. read marker
        this.sqlStateMarker = data[index];
        index++;
        // 4. read sqlState
        this.sqlState = com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.readFixedLengthBytes(data, index, 5);
        index += 5;
        // 5. read message

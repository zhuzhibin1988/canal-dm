...
public class EOFPacket extends PacketWithHeaderPacket {
    ...
    public void fromBytes(byte[] data) {
        ...
        index += 2;
        // 3. read status flag
        this.statusFlag = com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.readUnsignedShortLittleEndian(data, index);
        // end read
    }
    ...
    public byte[] toBytes() throws IOException {
        ...
        com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.writeUnsignedShortLittleEndian(this.warningCount, out);

package com.eshore.otter.canal.parse.driver.mysql.packets;
...
public class UUIDSet {
    ...
    public byte[] encode() throws IOException {
        ...
        com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.writeUnsignedInt64LittleEndian(intervals.size(), out);

        for (Interval interval : intervals) {
            com.eshore.otter.canal.parse.driver.mysql.utils.ByteHelper.writeUnsignedInt64LittleEndian(interval.start, out);
